...
const ROUTE_REGISTRY = [
  ...
  { method: 'GET',    path: '/api/system/update-status',            auth: 'localhost|jwt',  file: 'routes/system-ops.js' },
  { method: 'GET',    path: '/api/system/build-hash',               auth: true,        file: 'routes/system-ops.js' },
  { method: 'POST',   path: '/api/system/check-updates',            auth: 'localhost|jwt',  file: 'routes/system-ops.js' },
  { method: 'POST',   path: '/api/system/apply-update',             auth: 'localhost|jwt',  file: 'routes/system-ops.js' },
  { method: 'POST',   path: '/api/system/run-update',               auth: 'localhost|jwt',  file: 'routes/system-ops.js' },
  { method: 'GET',    path: '/api/system/auto-update-settings',     auth: true,        file: 'routes/system-ops.js' },
  { method: 'PATCH',  path: '/api/system/auto-update-settings',     auth: true,        file: 'routes/system-ops.js' },
  { method: 'POST',   path: '/api/system/trigger-update',           auth: 'localhost|jwt',  file: 'routes/system-ops.js' },
