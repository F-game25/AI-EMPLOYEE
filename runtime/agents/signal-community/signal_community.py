...
Reads state from polymarket-trader and mirofish-researcher agents, generates
...
def _ai(prompt: str, system: str = "") -> str:
    ...
    return (_query_ai_for_agent("signal-community", prompt, system_prompt=system) or {}).get("answer", "")
